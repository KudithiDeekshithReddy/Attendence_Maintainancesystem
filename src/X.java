...
public class X {
    ...
    public static void main (String[]args) throws Exception {
        ...
        if (Username.equals(Login_Username) && (Password.equals(Login_Password))) {
            ...
            do {
                System.out.println( "\n1.) Search for a student \n2.) Details of all attendees in a Sorted Manner \n3.)Segregate into categeory\n4.) Exit the Process." );
                System.out.println("\nEnter your choice : ");
                int num = sc.nextInt();
                ...
                switch (num) {
                    case 1: {
                        ...
                        if (name.equals("Raju")) {
                            System.out.println("Attendanchdhe percentage is" + " : " + h.att_per);
                        }
